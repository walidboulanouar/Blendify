          ...
          <div data-aos="fade-up" data-aos-delay="450">
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="flex items-center px-4 sm:px-8">
                    ...
                    >
                      <circle
                        className="fill-current text-teal-100 dark:hidden"
                        cx="16"
                        cy="16"
                        r="16"
                      />
              ...
              >
                <div className="flex pr-6 py-5 bg-white dark:bg-gray-800 divide-x divide-gray-200 dark:divide-gray-700 shadow-2xl">
                  ...
                  <div className="pl-6">
                    <header>
                      <h3 className="font-red-hat-display text-xl font-black tracking-tighter mb-1">
                        <a href="#0">Connect a custom domain on Blendify</a>
                      </h3>
                    </header>
                    <p className="text-gray-600 dark:text-gray-400">
                      Et leo duis ut diam quam nulla porttitor porttitor lacus
            ...
            <nav className="flex justify-center sm:justify-between mt-12">
              ...
              <ul className="flex">
                <li className="mx-1">
                  <a
                    className="inline-flex text-teal-500 px-1 border-b border-teal-500 transition duration-150 ease-in-out"
                    href="#0"
                  >
                    1
                  </a>
              ...
              <a
                className="hidden sm:inline-flex items-center font-medium text-teal-500 hover:underline"
                href="#0"
              >
                <span>Next</span>
                <svg
