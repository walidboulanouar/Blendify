...
export default function TestimonialsCarousel() {
  ...
  const items: Item[] = [
    {
      quote:
        "“ When we first met Blendify, we were skeptical. We tried lots of things before and none of them worked. But, when we tested the Shape Builder it just perfect for our needs. “",
      name: "Alexandre Park",
    ...
    {
      quote:
        "“ I feel grateful that Simple pushed me to expand my horizons and strive to accomplish more. When we first met Blendify, we were skeptical for no reason.“",
      name: "Dominik Prasad",
