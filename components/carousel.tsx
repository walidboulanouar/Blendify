...
import CarouselImage01 from "@/public/images/carousel-item-01.png";
import CarouselImage02 from "@/public/images/carousel-item-02.png";
import CarouselImage03 from "@/public/images/carousel-item-03.png";
import CarouselImage04 from "@/public/images/carousel-item-04.png";
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 font-red-hat-display mb-4">
              Explore Endless Possibilities with Blendify AI
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-400">
              Dive into a world where your imagination becomes your reality.
              Browse through a library of images crafted by users like you.
            </p>
          </div>
        </div>
